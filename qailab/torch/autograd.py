...
class ExpVQCFunction(Function):  # pylint: disable=abstract-method
    ...
    @staticmethod
    def _backward_single(fn_in, weight, launcher_backward, grad_output) -> tuple[torch.Tensor, torch.Tensor]:
        fn_in_numpy = fn_in.detach().numpy()
        weight_numpy = weight.detach().numpy()
...
class ExpVQCFunctionMP(Function):  # pylint: disable=abstract-method
    ...
    @staticmethod
    def _forward_single(fn_in: torch.Tensor, weight: torch.Tensor, launcher_forward: QLauncher, aql_instance: AQL):
    ...
    @staticmethod
    def _backward_single(fn_in, weight, launcher_backward, aql_instance: AQL):
        fn_in_numpy = fn_in.cpu().detach().numpy()
        weight_numpy = weight.cpu().detach().numpy()
